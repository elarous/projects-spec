(defproject projects-spec "0.1.0-SNAPSHOT"
  ...
  :main ^:skip-aot projects-spec.core
  ...
  {:uberjar {:omit-source true
             ...
             :aot :all
             :uberjar-name "projects-spec.jar"
                  ...
                  {:builds
                   {:app
                    {:source-paths ["src/cljs" "src/cljc" "env/dev/cljs"]
                     :figwheel {:on-jsload "projects-spec.core/mount-components"}
                     :compiler
                     {:main "projects-spec.app"
                      :asset-path "/js/out"
                      :output-to "target/cljsbuild/public/js/app.js"
